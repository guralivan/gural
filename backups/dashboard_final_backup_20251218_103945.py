...
if uploaded is None:
    ...
    if df is None or df.empty:
        ...
        if PROPHET_AVAILABLE:
            tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["📊 Анализ данных", "⚙️ Установка параметров", "📈 Аналитика по параметрам", "🔮 Прогнозирование", "🗺️ План продаж", "📦 Расчет заказа"])
        else:
            tab1, tab2, tab3, tab4, tab5 = st.tabs(["📊 Анализ данных", "⚙️ Установка параметров", "📈 Аналитика по параметрам", "🗺️ План продаж", "📦 Расчет заказа"])
...
# end of file
            st.header("💰 Юнит-экономика и расчёт прибыли")
