...
# Простой скрипт запуска календаря производства
...
# Останавливаем процесс на порту 8506 если он занят
if lsof -Pi :8506 -sTCP:LISTEN -t >/dev/null ; then
    echo "⚠️  Порт 8506 уже занят. Останавливаю процесс..."
    lsof -ti:8506 | xargs kill -9
    sleep 2
fi

# Запускаем календарь производства
echo "🚀 Запуск календаря производства на порту 8506..."
