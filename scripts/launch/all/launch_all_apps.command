...
# ИИ-аналитик на порту 8515 (новое)
echo "🤖 Запуск ИИ-аналитика на порту 8515..."
streamlit run apps/ai_analyst/ai_analyst.py --server.port 8515 --server.address localhost &
sleep 3
...
echo "   🤖 ИИ-аналитик: http://localhost:8515 (новое)"
if [ -f "UNIT/unit_economics_products_table_FINAL.py" ]; then
